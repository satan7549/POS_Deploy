...
const preMadeFoodSchema = Schema({
  nameFood: { type: String, maxlength: [50, "Maximum 50 charcters are permitted"],  minLength: [5, "persons should have more than 5 character"], required: [true, "please enter foodName"], trim: true, },
