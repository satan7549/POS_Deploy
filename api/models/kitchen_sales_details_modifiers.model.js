...
const kitchenSalesDetailsModifiersSchema = new Schema({
  ...
  order_status: { type: Number, required: true, comment: '1=new order,2=invoiced order, 3=closed order' },
...
const KitchenSalesDetailsModifiers = mongoose.model('KitchenSalesDetailsModifiers', kitchenSalesDetailsModifiersSchema);
