...
const ingredientCategorySchema = Joi.object({
    ...
    .messages({
      ...
      "string.min": "ingredientCategory_name should have at least {#limit} characters",
      "string.max": "ingredientCategory_name should have at most {#limit} characters",
      "any.required": "ingredientCategory_name is required",
    }),
  description: Joi.string().min(10).max(100).required().trim()
    .messages({
